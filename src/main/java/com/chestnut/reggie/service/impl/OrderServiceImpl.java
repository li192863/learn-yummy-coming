...
import com.chestnut.reggie.entity.*;
import com.chestnut.reggie.mapper.OrderMapper;
import com.chestnut.reggie.service.*;
...
public class OrderServiceImpl extends ServiceImpl<OrderMapper, Orders> implements OrderService {
    ...
    public void submit(Orders orders) {
        ...
        if (addressBook == null) {
            throw new CustomException("用户地址信息为空，无法下单");
        }
